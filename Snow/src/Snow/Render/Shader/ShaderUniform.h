...
namespace Snow {
    namespace Render {
        ...
        public:
            ShaderResource() {}
            ShaderResource(const std::string& name, Render::ShaderType stage, ResourceType type, uint32_t resourceRegister, uint32_t count = 1) :
                Name(name), Register(resourceRegister), Count(count) {}
