...
namespace Snow {
	namespace Math {
		...
		struct Matrix<2, 3, T> {
			...
			Matrix(const X1& x1, const X2& x2, const X3& x3, const Y1& y1, const Y2& y2, const Y3& y3);

			template<typename V1, typename V2>
			Matrix(const Vector<3, V1>& v1, const Vector<3, V2>& v2);

			//matrix conversions

			template<typename U>
			Matrix(const Matrix<2, 3, U>& m);
			...
			template<typename U>
			Matrix<2, 3, T>& operator=(const Matrix<2, 3, U>& m);

			template<typename U>
			Matrix<2, 3, T>& operator+=(U scalar);
		...
		//unary operators
		template<typename T>
		Matrix<2, 3, T> operator+(const Matrix<2, 3, T>& m);
		...
		template<typename T>
		Matrix<2, 3, T> operator+(const Matrix<2, 3, T>& m, T scalar);

		template<typename T>
		Matrix<2, 3, T> operator+(T scalar, const Matrix<2, 3, T>& m);
		...
		template<typename T>
		typename Matrix<2, 3, T>::col_type operator*(const Matrix<2, 3, T>& m, const typename Matrix<2, 3, T>::row_type& v);

		template<typename T>
		typename Matrix<2, 3, T>::row_type operator*(const typename Matrix<2, 3, T>::col_type& v, const Matrix<2, 3, T>& m);
        ...
        typedef Matrix<2, 3, bool>         Matrix2x3b;
        typedef Matrix<2, 3, short>        Matrix2x3s;
        typedef Matrix<2, 3, int>          Matrix2x3i;
        typedef Matrix<2, 3, unsigned int> Matrix2x3ui;
        typedef Matrix<2, 3, long>         Matrix2x3l;
        typedef Matrix<2, 3, unsigned long> Matrix2x3ul;
	}
}
#include "Snow/Math/Matrix/Matrix2x3.inl"