...
#if VULKAN
layout(set = 1, binding = 0) uniform samplerCube inputTexture;
#else
layout(binding = 0) uniform samplerCube inputTexture;
#endif

#if VULKAN
layout(set = 1, binding = 0, rgba16f) restrict writeonly uniform imageCube outputTexture;
#else
